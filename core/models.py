...
class Categorias(models.Model):
    ...
    # categoria = models.ForeignKey('Produtos', blank=True, null=True, related_name='categorias')
...
class Produtos(models.Model):
    ...
    # cod_cat = models.PositiveIntegerField(db_column='COD_CAT', max_length=5, blank=True, null=True)  # Field name made lowercase.
